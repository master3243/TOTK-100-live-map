...
function updateLiveSaveRows() {
  ...
  for (const row of metricRows) {
    ...
    row.classList.toggle("live-save-row-action", row.dataset.liveRow === "armor-upgraded" || row.dataset.liveRow === "recipes");
    row.classList.toggle("live-save-row-danger", (row.dataset.liveRow === "armor-upgraded" || row.dataset.liveRow === "recipes") && !complete);
    if (complete) {
