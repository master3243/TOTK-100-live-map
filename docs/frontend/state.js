...
const {
  ...
  pristineWeaponsSummary, fabricsSummary, fabricsAmiiboSummary, materialsSummary, keyItemsSummary,
  memoriesSummary, characterProfilesSummary, zonaiDevicesSummary,
  ...
  "compendiumSummary", "pristineWeaponsSummary", "fabricsSummary", "fabricsAmiiboSummary", "materialsSummary",
  "keyItemsSummary", "memoriesSummary", "characterProfilesSummary", "zonaiDevicesSummary",
  "questsMainSummary", "questsAdventureSummary", "questsSideSummary",
...
const completionStatSummaries = [
  ...
  {
    id: "fabrics_amiibo",
    title: "Fabrics (Amiibo)",
    element: fabricsAmiiboSummary,
    missingPrefix: "Still left",
    completeText: "All amiibo fabrics collected",
    tooltipCompleteText: "All amiibo fabrics collected.",
    emptyText: "No amiibo fabric data loaded",
  },
  {
    id: "materials",
    title: "Materials",
  ...
  },
  {
    id: "memories",
    title: "Memories",
    element: memoriesSummary,
    missingPrefix: "Still left",
    completeText: "All memories unlocked",
    tooltipCompleteText: "All memories unlocked.",
    emptyText: "No memory data loaded",
  },
  {
    id: "character_profiles",
    title: "Character Profiles",
    element: characterProfilesSummary,
    missingPrefix: "Still missing",
    completeText: "All character profiles unlocked",
    tooltipCompleteText: "All character profiles unlocked.",
    emptyText: "No character profile data loaded",
  },
  {
    id: "zonai_devices",
    title: "Zonai Devices",
    element: zonaiDevicesSummary,
    missingPrefix: "Still missing",
    completeText: "All Zonai devices collected",
    tooltipCompleteText: "All Zonai devices collected.",
    emptyText: "No Zonai device data loaded",
  },
];
const overlayInputs = {
